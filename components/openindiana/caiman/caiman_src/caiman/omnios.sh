...
#
export NIGHTLY_OPTIONS="-AMNndlmp +t";
...
export CODEMGR_WS="/root/pluribus_userland/components/openindiana/caiman/caiman"

# PARENT_WS is used to determine the parent of this workspace. This is
# for the options that deal with the parent workspace (such as where the
# proto area will go).
export PARENT_WS="ssh://src@src.omniti.com/~omni-os/core/caiman"
...
#export CLONE_WS="ssh://src@src.omniti.com/~omni-os/core/caiman"
...
#POST_NIGHTLY=
PKGPUBLISHER_REDIST=userland.pluribusnetworks.com; export PKGPUBLISHER_REDIST;
PKGVERS_BRANCH=0.144; export PKGVERS_BRANCH;
